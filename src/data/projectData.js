export const projectDataList = [
    ...
    and visualize the HSL (hue, saturation, lightness)
    colour system. Name and save favourite colours for
    future use.`,
        links: {
    ...
    {
        title: `Nonstop News`,
        skills: ['React', 'Redux', 'SCSS', 'Styled-Components'],
        description: `Nonstop News displays news article headlines from
    all over the web. Browse popular highlights by
    ...
    },
    {
        title: `Game Atlas`,
        skills: ['React', 'SCSS'],
        description: `Game Atlas is a game database search application
    for looking up your favourite games. This
    application utilizes the IGDB API to receive and
    inject data based off the user's search query.`,
        links: {
    ...
    {
        title: `Cryptosh`,
        skills: ['JavaScript', 'SCSS', 'Webpack'],
        description: `Cryptosh is the homepage showcase for the fake
    e-commerce product "Cryptosh".`,
        links: {
